const CACHE='solari-static-shell-v2';
const SHELL=['./','./index.html','./styles.css','./app.js','./storage.js','./sources.js','./schema.js','./crypto.js','./security.js','./exports.js','./manifest.webmanifest'];
