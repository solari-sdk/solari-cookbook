const CACHE='solari-static-shell-v3';
const SHELL=['./','./index.html','./styles.css','./app.js','./storage.js','./sources.js','./schema.js','./crypto.js','./security.js','./exports.js','./artifacts.js','./filters.js','./merge.js','./graph.js','./graph-bootstrap.js','./manifest.webmanifest'];
