const CACHE='solari-static-shell-v5';
const SHELL=['./','./index.html','./styles.css','./app.js','./storage.js','./sources.js','./broker.js','./schema.js','./domain-contract.json','./crypto.js','./security.js','./exports.js','./artifacts.js','./filters.js','./merge.js','./graph.js','./graph-bootstrap.js','./manifest.webmanifest'];
