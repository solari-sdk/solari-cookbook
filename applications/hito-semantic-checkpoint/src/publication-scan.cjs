...
const KNOWN = new Set([
  ...
  ...[
    ...
    "routing.ts",
    "storage.ts",
    "stretch-resources.ts",
    "stretch-harness.ts",
    "stretch-entry.ts",
  ].map((n) => "src/" + n),
  "tests/application.test.ts",
  "tests/publication.test.ts",
  "tests/stretch.test.ts",
  "tests/stretch-r2.test.ts",
  "tests/apparatus.test.ts",
  ...[
    "architecture.md",
    "public-subset.md",
    "evidence-boundary.md",
    "solari-opportunity.md",
    "solari-platform-opportunity.md",
    "solari-api-census.md",
    "stretch-matrix.md",
    "stretch-live-plan.md",
  ...
  ...[
    ...
    "R1C_SUMMARY.json",
    "R2_SUMMARY.json",
    "CONTINUITY_NATIVE_ATTEMPT1_SUMMARY.json",
    "CONTINUITY_NATIVE_ATTEMPT2_SUMMARY.json",
  ].map((n) => "evidence/" + n),
