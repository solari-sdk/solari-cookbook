...
| [desktop-research-brief](desktop-research-brief) | Python | Research a company from screenshots alone and write a cited brief in a desktop editor: planned sources, checkpointed findings, verified save |