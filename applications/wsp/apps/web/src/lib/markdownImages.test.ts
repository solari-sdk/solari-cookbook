// Adapted from pingdotgg/t3code packages/client-runtime/src/markdownImages.test.ts at 57a66608 (MIT).
// Differs from upstream: the blob fixture host is app.example.com instead of the upstream product host.
import { describe, expect, it } from "vitest";

import { classifyMarkdownImageSource, markdownImageSourceFragment } from "./markdownImages";
