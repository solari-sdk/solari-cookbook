// Adapted from pingdotgg/t3code apps/web/src/markdown-links.test.ts at 57a66608 (MIT).
// Differs from upstream: fixture paths use "myrepo", CONTRIBUTING.md and ".config" where upstream used its repo name, AGENTS.md and a personal config dir.
...
describe("extractMarkdownLinkHrefs", () => {
  ...
  it("preserves ordinary destinations and ignores link titles", () => {
    expect(
      extractMarkdownLinkHrefs(
        '[source](apps/web/src/markdownLinks.ts "implementation") and [docs](https://example.com)',
      ),
    ).toEqual(["apps/web/src/markdownLinks.ts", "https://example.com"]);
  });
});
...
describe("rewriteMarkdownFileUriHref", () => {
  ...
  it("normalizes file uri hrefs for windows drive paths", () => {
    expect(
      rewriteMarkdownFileUriHref(
        "file:///D:/Programme/myrepo/apps/web/src/components/chat/OpenInPicker.tsx#L69",
      ),
    ).toBe("D:/Programme/myrepo/apps/web/src/components/chat/OpenInPicker.tsx#L69");
  });
  ...
  it("unwraps angle-bracketed file uri hrefs", () => {
    expect(
      rewriteMarkdownFileUriHref(" <file:///D:/Programme/myrepo/apps/web/src/markdownLinks.ts> "),
    ).toBe("D:/Programme/myrepo/apps/web/src/markdownLinks.ts");
  });
});

describe("resolveMarkdownFileLinkTarget", () => {
  it("resolves absolute posix file paths", () => {
    expect(resolveMarkdownFileLinkTarget("/Users/julius/project/CONTRIBUTING.md")).toBe(
      "/Users/julius/project/CONTRIBUTING.md",
    );
  });
  ...
  it("resolves bare file names against cwd", () => {
    expect(resolveMarkdownFileLinkTarget("CONTRIBUTING.md", "/Users/julius/project")).toBe(
      "/Users/julius/project/CONTRIBUTING.md",
    );
  });
  ...
  it("formats tooltip display paths relative to the cwd when possible", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "file:///C:/Users/mike/dev-stuff/myrepo/apps/web/src/session-logic.ts#L501",
        "C:/Users/mike/dev-stuff/myrepo",
      ),
    ).toMatchObject({
      displayPath: "myrepo/apps/web/src/session-logic.ts:501",
  ...
  it("formats tooltip display paths relative to the cwd for slash-prefixed windows paths", () => {
    expect(
      resolveMarkdownFileLinkMeta(
        "/C:/Users/mike/dev-stuff/myrepo/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
        "C:/Users/mike/dev-stuff/myrepo",
      ),
    ).toMatchObject({
      displayPath:
        "myrepo/apps/web/src/components/chat/MessagesTimeline.virtualization.browser.tsx",
  ...
  it("normalizes slash-prefixed windows drive paths before resolving", () => {
    expect(
      resolveMarkdownFileLinkTarget(
        "/D:/Programme/myrepo/apps/web/src/components/chat/OpenInPicker.tsx#L69",
      ),
    ).toBe("D:/Programme/myrepo/apps/web/src/components/chat/OpenInPicker.tsx:69");
  });

  it("resolves angle-bracketed windows drive paths", () => {
    expect(
      resolveMarkdownFileLinkTarget(
        "</D:/Programme/myrepo/apps/web/src/components/ChatMarkdown.tsx:1>",
      ),
    ).toBe("D:/Programme/myrepo/apps/web/src/components/ChatMarkdown.tsx:1");
  });
...
describe("resolveInlineCodeFileLinkMeta", () => {
  ...
  it("links absolute posix paths", () => {
    expect(resolveInlineCodeFileLinkMeta("/Users/julius/project/CONTRIBUTING.md")).toMatchObject({
      targetPath: "/Users/julius/project/CONTRIBUTING.md",
    });
  ...
  it("links bare filenames only when a line suffix marks them as file references", () => {
    ...
    expect(resolveInlineCodeFileLinkMeta("CONTRIBUTING.md", "/Users/julius/project")).toBeNull();
  });
  ...
  it("does not treat arbitrary name:digits shapes as files", () => {
    ...
    expect(resolveInlineCodeFileLinkMeta("NOTE:12", "/Users/julius/project")).toBeNull();
...
describe("directory paths with a trailing separator", () => {
  ...
  it("keeps the final segment for a Windows directory path", () => {
    expect(
      resolveMarkdownFileLinkMeta("C:\\Users\\kelchm\\.config\\", "/repo/project"),
    ).toMatchObject({ basename: ".config" });
  });
