// Adapted from pingdotgg/t3code apps/web/src/markdown-list-indentation.ts at 57a66608 (MIT).
// Differs from upstream: the INLINE_PARSE_PREFIX sentinel drops the brand word; it is internal and never rendered.
...
const INLINE_PARSE_PREFIX = "markdown-inline-prefix:";
