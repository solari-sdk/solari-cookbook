// Adapted from pingdotgg/t3code packages/client-runtime/src/work-log/scrollAnchor.test.ts at 57a66608 (MIT).
import { describe, expect, it } from "vitest";

import { resolveWorkGroupScrollAnchor } from "./scrollAnchor";
