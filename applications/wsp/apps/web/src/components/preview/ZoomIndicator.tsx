...
export function ZoomIndicator({ zoomFactor }: Props) {
  ...
  return (
    <div
      aria-hidden={!visible}
      className={cn(
        "pointer-events-none absolute top-3 right-3 z-20 select-none rounded-full border border-border/70 bg-popover/95 px-2.5 py-1 text-xs font-medium text-foreground shadow-md/10 glass-backdrop transition-all duration-200 ease-out",
