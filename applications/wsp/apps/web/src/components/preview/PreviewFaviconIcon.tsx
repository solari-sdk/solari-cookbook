// Adapted from pingdotgg/t3code apps/web/src/components/preview/PreviewFaviconIcon.tsx at 57a66608 (MIT).
// The favicon store hook (useFaviconForThreadUrl, Electron-fed) is a `source` prop here.
