...
// A pick closes the menu here, where the kit leaves it open: an option menu that stays up sits over the page and
// eats the next click, which is what every picker in the composer did. A list whose rows walk somewhere inside the
// open menu rather than picking passes false.
